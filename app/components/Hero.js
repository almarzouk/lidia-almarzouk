      ...
      >
        ...
        <div className="flex flex-col justify-center p-6 md:p-12 text-gray-800">
          ...
          <p className="text-lg md:text-xl font-medium leading-relaxed mb-6 text-center">
            انضموا إلينا للاحتفال بعيد ميلاد ليديا يوم 🎈🥳 استعدوا للحفلة
            الرائعة مع العائلة والأصدقاء.
          </p>
          ...
          >
            ...
            <p className="text-right md:text-lg text-gray-700 leading-relaxed">
              عام مضى منذ أن غدا صباحنا وجهها، وليلنا سمر بها، وسهر على أمنها..
              عام جميل كعينيها، دافئ كضحكتها، مليء بالرزق والسكينة والحب
              والخير.. الحمد لله أولاً والشكر لكل من ساندنا في هذا العام
            </p>
          </motion.div>
